...
#Tak did not distinguish between opioid and sedative hypnotic

#full_consensus = human_ratings.loc[human_ratings['tak_toxidrome']==human_ratings['barbuto_toxidrome']]

full_consensus = human_ratings.copy()

full_consensus = full_consensus.rename(columns={"barbuto_toxidrome":"human_toxidrome"})
